recv_0 = [0x91, 0x03, 0x34, 0xf1, 0x1d, 0x76, 0x44, 0xe3]
recv_1 = [0x01, 0xc1, 0xcc, 0x4b, 0xc0, 0x79, 0xbf, 0x77, 
...
recv_1 += [0xce, 0xcc, 0xad, 0xe0, 0xa2, 0xde, 0x14, 0x6e, 
...
recv_1 += [0xec, 0x43, 0x8f, 0x32, 0xd5, 0x30, 0x4c, 0x93, 
...
recv_1 += [0x76, 0x4d, 0x8d, 0xac, 0xe3, 0xe7, 0x21, 0xb6, 
...
recv_1 += [0xd5, 0x76, 0x98, 0x10, 0x46, 0x3f, 0xb8, 0x3a, 
...
recv_1 += [0xd2, 0x60, 0x34, 0xd8, 0x85, 0x24, 0xbe, 0xa9, 
...
xoring = lambda x,y : ''.join([chr(ch ^ y[i%len(y)]) for i, ch in enumerate(x)])

# print(len(recv_1))
recv_0 = open('recv1_DUMP_af', 'rb').read()

v22_0_256 = [i for i in range(256)]


j = 0
v10 = 0
while (j < 256):
    v14 = v22_0_256[j]#v13[j]
    v15 = j
    j += 1
    v10 = v14 + v10 + recv_0[j%256]
    print(v10)
    v22_0_256[j-1] = recv_1[v10]
    v22_0_256[v10] = v14
print(v22_0_256)
...
# n = 0
# v8 = 0
# v18 = open('recv2_DUMP_af', 'rb').read()
# cnt = 0
# v3 = 0
# while (v3 < 7680):
#     v8 = (v8 + 1) % 256
...
#     v19 = v22_0_256[n]
#     v22_0_256[n] = v20
#     v17[n] = v17[cnt] ^ v22_0_256[v19 + v20]
#     cnt += 1
#     v3 += 1
# print(bytearray(v17))
